...
const AddRoom = () => {
    return(
        <>
            ...
            <div className="baloo2 is-flex is-flex-direction-column is-align-itens-center is-justify-content-center conteudo mt-5 ml-6 mr-6">
                <div className="mr-6">
                    <h1 className="is-size-5 has-text-weight-semibold">Cadastrar Quarto</h1><br/> {/* ADICIONAR BORDA E TAMANHO */}
