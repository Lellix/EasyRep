    ...
    return(
        <>
            <nav className="is-flex is-justify-content-center baloo2">
                <div className="homeCard px-6 mb-5 mt-5 is-flex is-flex-direction-row is-justify-content-center is-align-content-center">
                    ...
                    <div className="is-align-items-center is-flex is-flex-direction-column is-flex-grow-1 is-justify-content-center">
